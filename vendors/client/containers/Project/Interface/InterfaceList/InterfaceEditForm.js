...
const dataTpl = {
  req_query: { name: '', required: '1', desc: '', example: '',gateway: '' },
      ...
      return (
        <Row key={index} className="interface-edit-item-content">
          ...
          <Col span="5" className="interface-edit-item-content-col">
            ...
            })(<TextArea autosize={true} placeholder="数据类型" />)}
          </Col>
          <Col span="5" className="interface-edit-item-content-col">
            {getFieldDecorator('req_query[' + index + '].desc', {
              initialValue: data.desc
            })(<TextArea autosize={true} placeholder="字段" />)}
          </Col>
          <Col span="5" className="interface-edit-item-content-col">
            {getFieldDecorator('req_query[' + index + '].gateway', {
              initialValue: data.gateway
            })(<TextArea autosize={true} placeholder="网关" />)}
          </Col>
